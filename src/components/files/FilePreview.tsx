...
export function FilePreview() {
  ...
  return (
    <div data-testid="file-preview" className="flex flex-col h-full bg-bg-primary" onKeyDown={handleKeyDown}>
      ...
      <div className="flex items-center justify-between h-[68px] px-3 pt-[20px]
        ...
        <div className="flex items-center gap-1.5 flex-shrink-0">
          ...
          {/* Mode toggle tabs */}
          {modeTabs.length > 0 && (
            <div className="flex gap-0.5 bg-bg-tertiary/50 rounded-lg p-1">
              {modeTabs.map((tab) => (
                <button
                  key={tab.id}
          ...
          <div className="bg-bg-card border border-border-subtle rounded-lg p-5
            ...
            <div className="flex justify-end gap-2">
              ...
              <button
                ...
                className="px-3 py-1.5 text-xs rounded-md bg-accent
